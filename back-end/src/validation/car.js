...
const carValidationSchema = z.object({
  ...
  created_user_id: z.number().int().positive().optional(),
  updated_user_id: z.number().int().positive().optional()
})
...
export { carValidationSchema, carCreateSchema, carUpdateSchema }